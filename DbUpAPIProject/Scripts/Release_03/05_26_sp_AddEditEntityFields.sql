        ...
        BEGIN TRY  
            ...
            (  
                ...
                BEGIN  
                    ...
                    INSERT INTO #tempFormFieldConstraints  
                    (ConstraintTypeId,   
                     ConstraintName,   
                     Settings  
                    )  
                           SELECT ConstraintTypeId,   
                                  ConstraintName,   
                                  Settings  
                           FROM OPENJSON(@constraintsettings) WITH(ConstraintTypeId INT, ConstraintName NVARCHAR(100), Settings NVARCHAR(4000));  
                    ...
                    (@formsectionfieldid,  
                     CASE  
                         WHEN SOURCE.ConstraintTypeId = 0  
                         THEN NULL  
                         ELSE SOURCE.ConstraintTypeId  
                     END,  
                     CASE  
                         WHEN SOURCE.Settings IS NULL  
                         THEN NULL  
