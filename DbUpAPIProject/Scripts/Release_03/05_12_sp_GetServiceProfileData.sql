...
-- sp_GetServiceProfileData 3,null,'09a5a5f0-6b8f-4a33-bf1f-bd45aee6a9e0','Sanjay'                       
-- =============================================                        
...
AS                
    BEGIN                
        DECLARE @uId INT, @serviceTranslationKeyId INT= 11, @fieldTranslationKeyId INT= 1, @closeStatusTranslationKeyId INT= 2, @systemLookupTranslationKeyId INT = 18, @lookupsTranslationKeyId INT = 8, @lookupFieldTypeId int = 5;                
