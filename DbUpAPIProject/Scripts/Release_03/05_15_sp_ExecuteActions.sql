...
AS  
    BEGIN  
        ...
        DECLARE @stageid AS INT, @serviceid AS INT, @statusId AS INT, @stagestatusid AS INT, @parentId AS INT, @entityFieldId AS INT, @value AS NVARCHAR(1000), @childrensJson AS NVARCHAR(MAX), @applicationstageid AS INT, @nextstageavailability AS BIT= 0, 
@appStageActionId INT, @attachmentActionId INT, @attachmentAppStageId INT, @actiontypeid INT, @TostageId BIT= 0, @applicationstatusid INT;  
  
        -- Declaration of lookups      
        DECLARE @openstagestatusid AS INT= 1, @closestagestatusid AS INT= 2, @submitstageactiontypeid AS INT= 2, @rejectactiontypeid AS INT= 5, @returnactiontypeid AS INT= 6, @modificationstagestatusid AS INT= 5, @returnstagestatusid AS INT= 4, @rejecteds
tagestatusid AS INT= 3, @assigntouseractiontypeid AS INT= 8, @newstagestatusid AS INT;  
