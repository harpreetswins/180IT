...
/****** Object:  StoredProcedure [admin].[sp_AddEditEntities]    Script Date: 02-02-2021 15:03:33 ******/
SET ANSI_NULLS ON
GO
 ...
 --Select @translationkeyid = Id from system.TranslationKeys Where Name = 'Entity';  
  ...
  BEGIN TRY      
   ...
   Name,  
    ...
    END
GO
/****** Object:  StoredProcedure [admin].[sp_AddEditForms]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS  
    ...
    END;
GO
/****** Object:  StoredProcedure [admin].[sp_AddEditStages]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
    ...
    END;
GO
/****** Object:  StoredProcedure [admin].[sp_AddGroups]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS    
    ...
    END;
GO
/****** Object:  StoredProcedure [admin].[sp_AddServices]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
    ...
    END;
GO
/****** Object:  StoredProcedure [admin].[sp_AddUpdateStageActions]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS        
   ...
   END       
    ...
    END;
GO
/****** Object:  StoredProcedure [admin].[sp_AdminDeleteStageActions]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS  
    ...
    END;
GO
/****** Object:  StoredProcedure [admin].[sp_AdminGetForms]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
    ...
    END;
GO
/****** Object:  StoredProcedure [admin].[sp_AdminGetRoles]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS  
    ...
    END;
GO
/****** Object:  StoredProcedure [admin].[sp_AdminGetStageForms]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
DECLARE @formTranslationKeyId INT= 2;      
  ...
  END
GO
/****** Object:  StoredProcedure [admin].[sp_AdminLinkUnlinkStageForms]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS  
    ...
    END;
GO
/****** Object:  StoredProcedure [admin].[sp_DeleteGroup]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
    ...
    END;
GO
/****** Object:  StoredProcedure [admin].[sp_DeleteService]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
    ...
    END;
GO
/****** Object:  StoredProcedure [admin].[sp_DeleteStages]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [admin].[sp_GetAllEntities]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
    ...
    END;
GO
/****** Object:  StoredProcedure [admin].[sp_GetAllStageTypes]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS  
    ...
    END;
GO
/****** Object:  StoredProcedure [admin].[sp_GetGroupsById]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
    ...
    END;
GO
/****** Object:  StoredProcedure [admin].[sp_GetServicesById]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS  
    ...
    END;
GO
/****** Object:  StoredProcedure [admin].[sp_GetStageActionsByStageId]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
    ...
    END;
GO
/****** Object:  StoredProcedure [admin].[sp_GetStageActionTypes]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS  
    ...
    END;
GO
/****** Object:  StoredProcedure [admin].[sp_GetStagesByServiceId]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS        
  ...
  (Select RoleId from service.StageActionRoles Where StageActionId = SSA.Id FOR JSON PATH) AS StageActionRoles   
    ...
    END;
GO
/****** Object:  StoredProcedure [admin].[sp_ReorderGroups]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS  
  ...
  END  
   ...
   SELECT @GroupId AS Id,   
    ...
    END;
GO
/****** Object:  StoredProcedure [admin].[sp_ReorderServices]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
    ...
    END;
GO
/****** Object:  StoredProcedure [admin].[sp_ReorderStages]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS    
  ...
  IF(@PreviousOrderNo < @NewOrderNo)    
   ...
   SELECT @StageId AS Id,     
    ...
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_AddApplications]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
    ...
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_AddLog]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
    ...
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_CheckCurrentApplicationStatus]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
    ...
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_DeleteActionAttachment]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_DeleteAttachment]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_ExecuteActions]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
    ...
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_GetActionAttachmentById]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS  
    ...
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_GetAllLanguages]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
    ...
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_GetApplicationActivityLogs]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS        
    BEGIN        
      ...
      --AND CONVERT(Char(16),APTS.CreatedDateTime ,20) =  CONVERT(Char(16),AASA.CreatedOn ,20)    
    ...
    END;        
GO
/****** Object:  StoredProcedure [dbo].[sp_GetApplicationChildForm]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
    ...
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_GetApplicationCurrentStage]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
    ...
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_GetApplicationForm]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS  
  ...
  Select TOP 1 @currentStageId = StageId FROM vw_ApplicationStagesOrderBy AAS Where ApplicationId = @applicationid --ORDER BY 1 DESC  
  ...
  END  
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_GetApplicationPaymentDetail]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
    ...
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_GetAttachment]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
    ...
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_GetAttachmentById]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
    ...
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_GetCascadedLookupValues]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS    
    ...
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_GetChildEntityFieldLookups]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS              
 ...
 DECLARE @lookupTranslationKeyId INT = 8, @systemLookupTranslationKeyId INT = 18;      
    ...
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_GetEntityFieldLookups]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS                
 ...
 DECLARE @lookupTranslationKeyId INT = 8, @systemLookupTranslationKeyId INT = 18;      
    ...
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGroupsAndServices]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS          
 ...
 DECLARE @groupTranslationKeyId INT = 14, @groupDescTranslationKeyId INT = 15, @serviceTranslationKeyId INT = 11, @serviceDescTranslationKeyId INT = 16;    
  ...
  ORDER BY OrderNumber;  
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGroupServices]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS          
 ...
 DECLARE @groupTranslationKeyId INT = 14, @serviceTranslationKeyId INT = 11, @serviceDescriptionTranslationKeyId INT = 16;  
   ...
   ORDER BY S.OrderNumber ASC FOR JSON PATH          
    ...
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_GetResourceKeyValues]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
    ...
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_GetRoleId]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS  
 ...
 INSERT INTO @temp(Roles) SELECT Item FROM SplitString(@Role, ',');  
   ...
   SELECT Id FROM [service].[Roles] WHERE [Name] IN (SELECT Roles FROM @temp);  
    ...
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_GetServiceProfileData]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
    ...
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_GetStateMachineJson]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_GetUpdateTransactionDetail]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[sp_GetUserApplicationCategories]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS    
    ...
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_GetUserApplicationsDetail]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
--PRINT @uId
    ...
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_GetUserApplicationsList]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
    ...
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_GetUserId]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_GetUserPaymentList]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
EXEC @uId= sp_GetUserId @creatorid               
 ...
 OPTION (RECOMPILE)      
  ...
  END
GO
/****** Object:  StoredProcedure [dbo].[sp_GetUserPermissionForService]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
  ...
  IF EXISTS (select ISNULL(ServiceId, 0) From service.ServiceProfiles Where ServiceId = @serviceid)
   ...
   SELECT @NeedProfile AS NeedProfile, @Exist AS Permission
    ...
    END;
GO
/****** Object:  StoredProcedure [dbo].[sp_TranslationsCleanup]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_UploadActionAttachments]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_UploadAttachments]    Script Date: 02-02-2021 15:03:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
